...
radius_slider.addEventListener( 'mouseup', onmouseup, false )
...
rotate_slider.addEventListener( 'touchend', onSliderChange, false )
...
async function compute(){
  ...
  data.inputs = {
    'Density': density_slider.valueAsNumber,
    'Radius': radius_slider.valueAsNumber,
    'Height': height_slider.valueAsNumber,
    'Rotate': rotate_slider.valueAsNumber,
  }
